...
<!-- ISI BARU -->
	<div class="container" id="menu">
		<h1 style="margin-top: 100px; text-align: center;"> INPUT MENU</h1>
		<button style="margin-left: 480px;" type="button" class="btn btn-success" data-toggle="modal" data-target="#tambahMalmilFood">Input MalMil</button>
