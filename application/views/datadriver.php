...
<head>
	...
	<title>Admin | Data Driver ~ Cemal-Cemil</title>
...
<!-- ISI BARU -->
	<div class="container" id="menu">
		<h1 style="margin-top: 100px; text-align: center;"> DATA - DRIVER </h1>
		<h5 style="text-align: center;"> * berikut adalah data driver * </h5>
		<div class="row">
			<div class="col-md-12">
				<table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
					...
					<tbody>
				        ...
				        <tr>
				        <td>$no</td>
				        <td><img class=\"rounded-circle\" src=\"".base_url()."/assets/$view->gambar\" width= \"300\" height=\"300\"></td>
				        <td>$view->namaDriver</td>
				        <td>$view->noPlat</td>
				        <td>$view->noHp</td>
				        <td>$view->rating</td>
				        </tr>";
